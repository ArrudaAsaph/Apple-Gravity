...
while True:
    ...
    if estado_de_jogo == "jogando":
        ...
        apples_golden, apples_golden_rect , condicao_queda = cair_apples_golden(
        apples_golden, apples_golden_rect, apple_speed,condicao_queda, lifes, cronometro,apple_golden_cont
        )
