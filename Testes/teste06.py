...
def capture_pears(pears, pears_rect, personagem_rect, score):
    new_pears = []
    new_pears_rect = []
    captured = False
    for i in range(len(pears)):
    ...
    return new_pears, new_pears_rect, captured, score
...
posicoes_usadas = []  # Lista para armazenar posições usadas recentemente
...
while True:
    ...
    if estado_de_jogo == "jogando":
        ...
        apples, apples_rect, captured, score = capture_apples(apples, apples_rect, personagem_rect, score)
